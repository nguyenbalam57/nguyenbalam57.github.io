<?php 
    ...
    $result_payment = $d->rawQuery("select desc_$lang as descs,name_$lang as name,id from #_posts where type=? and find_in_set ('hienthi',status)",array('hinh-thuc-thanh-toan'));
?>
                    ...
                    <div class="row  d-flex flex-wrap justify-content-between">
                        <div class="col--2 item">
                            <div class="layout-flex mb-15">
                                ...
                                <?php if(!$func->isLogin() && $config['login']==true){ ?>
            ...
            <div class="col-4 item coll-page">
                ...
                <div class="box-order">
                    ...
                    <div class="sidebar-total">
                        ...
                        <?php if($config['cart-coupon']==true){ ?>
                        <div class="subtotal"><div><?=_giam_gia?></div><div><span id="price-coupon"><?=(!$_SESSION['coupon']) ? 0:$func->moneyFormat($_SESSION['coupon']['percents-price'],'')?></span><span>₫</span></div></div>
                        <?php } ?>
