<?php 
	 ...
	 * @package PRO CODE JSWEBSITE FRAMEWORK
	 * @author  James Nguyễn <jamesit.8791@gmail.com>
	 * @version 1.0.0
	 * @license https://jnwebsite.vn
	 * @version   1.1.0
	 */
	...
	@define('_chamsoc_kh', 'Chăm sóc khách hàng');
	@define('_chinhsach_kh', 'Chính sách khách hàng');
	@define('_huongdan_kh', 'Hướng dẫn khách hàng');
	...
	@define('_them_vao_gio_hang', 'Thêm vào giỏ hàng');
