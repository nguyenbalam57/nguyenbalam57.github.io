                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group text-right mb-0">
                                    ...
                                    <?php /* <a role="button" href="index.html?com=products&act=man&type=<?=$csetting['type-key']?>" class="btn btn-fill btn-success">Về sản phẩm</a> */ ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php } ?>
                                <?php if($csetting['size']==true){ ?>
                                    <div class="col-md-4 pl-md-1 pr-md-1">
                                        <div class="form-group">
                                             <label class="font-weight-600">Kích thước</label>
                                             <input type="text" class="form-control" value="<?=$item['sizes']?>" id="sizes" name="data[sizes]" placeholder="Kích thước sản phẩm">
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if($csetting['material']==true){ ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-600">Chất liệu</label>
                                            <input type="text" class="form-control" value="<?=$item['materials']?>" id="material" name="data[material]" placeholder="Chất liệu ">
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
