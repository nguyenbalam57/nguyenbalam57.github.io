                        ...
                        <div class="wrap_bg_block_333_content">
                            <div class="count _1">
                                <svg class="total-revenue" style="width:50px;height:50px;">
                                    <use xlink:href="#total-revenue" xmlns:xlink="https://www.w3.org/1999/xlink"></use>
                                </svg>
                            </div>
                            <div class="content">
                                <h2 style="color:#928fd2;" data-bind="sumTotalSales"><?=$func->moneyFormat($total_price['total'],'')?></h2>
                                Tổng doanh thu
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="wrap_bg_block_333_content">
                            <div class="count _2">
                                <svg class="order-finalize" style="width:50px;height:50px; margin-left: 4px;">
                                    <use xlink:href="#order-finalize" xmlns:xlink="https://www.w3.org/1999/xlink"></use>
                                </svg>
                            </div>
                            <div class="content">
                        ...
                        <div class="wrap_bg_block_333_content">
                            <div class="count _3">
                                <svg class="order-return" style="width:50px;height:50px; margin-top: 4px;">
                                    <use xlink:href="#order-return" xmlns:xlink="https://www.w3.org/1999/xlink"></use>
                                </svg>
                            </div>
                            <div class="content">
                        ...
                        <div class="wrap_bg_block_333_content">
                            <div class="count _4">
                                <svg class="order-cancel" style="width:50px;height:50px;">
                                    <use xlink:href="#order-cancel" xmlns:xlink="https://www.w3.org/1999/xlink"></use>
                                </svg>
                            </div>
                            <div class="content">
                                ...
                                <tbody>
                                    ...
                                    <tr id="order-<?=$v['code']?>" class="item-tr <?=($v['view']==1) ? '':'font-bold'?>" data-id="<?=$v['id']?>" data-view="<?=$v['view']?>" data-table="orders">
                                        ...
                                        <td class="text-center">
                                            <?php /*<a href="index.html?com=orders&act=edit<?=$url_type?>&id=<?=$v['id']?>" class="btn btn-success-soft btn-sm mr-1"><i class="far fa-eye"></i></a>*/ ?>
                                            <a href="index.html?com=orders&act=delete<?=$url_type?>&id=<?=$v['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-danger-soft btn-sm"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                                                ...
                                                                <div class="row" style="flex-wrap: nowrap;">
                                                                    ...
                                                                    <div class="col-md-8 order-title">
                                                                        <select name="payment_status<?=$v['id']?>" id="payment_status<?=$v['id']?>" class="form-control status-select">
                                                                            <?php foreach ($config['payment_status'] as $k1 => $v1) { ?>
...
<div style="display: none;">
    ...
    <svg id="credit-card" width="100%" height="100%">
        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" enable-background="new 0 0 24 24">
