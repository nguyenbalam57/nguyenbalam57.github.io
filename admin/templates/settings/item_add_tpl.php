                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-0 lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                                    <label class="font-weight-600">Thời gian làm việc [<?=$v?>]</label>
                                    <input type="text" class="form-control" value="<?=$item['time_'.$k]?>" name="data[time_<?=$k?>]" placeholder="Thời gian làm việc">
                                </div>
                                <?php } ?>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="website-link">https://</span>
                                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="file" name="favicon" id="favicon" class="custom-input-file" data-multiple-caption="{count} files selected" multiple />
                                    <label for="favicon">
                                        <i class="fa fa-upload"></i>
                                        <span><?=($item['favicon']!='') ? _upload_photo.$item['favicon']:'Choose a file…'?></span>
                                    </label>
                                </div>
                            </div>
                        </div>
