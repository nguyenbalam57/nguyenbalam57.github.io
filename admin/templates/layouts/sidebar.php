<nav class="sidebar sidebar-bunker <?=($_GET['com']=='orders' && $_GET['act']=='add') ? 'active':''?>">
    <div class="sidebar-header" style="padding: 10px 0;text-align: center;display: block!important;height: auto!important;">
        <!--<a href="index.html" class="logo"><span>bd</span>task</a>-->
        <a href="index.html" class="logo"><img src="assets/dist/img/logo-ozo.png" style="max-width: 70%;height: auto!important;" alt=""></a>
    </div><!--/.sidebar header-->
    ...
    <div class="sidebar-body">
        <nav class="sidebar-nav">
            <ul class="metismenu">
                ...
                <?php } ?>
                <?php if($setting['product_properties']){ ?>
                <li class="<?=(!empty($setting['product_properties'][$_GET['type']])) ? 'mm-active':''?>">
                    <a class="has-arrow material-ripple" href="#">
                        <i class="typcn typcn-map mr-2"></i>
                        Quản lý thuộc tính
                    </a>
                    <ul class="nav-second-level">
                        <?php foreach($setting['product_properties'] as $k => $v) { ?>
                            <li><a class="<?=($_GET['com']=='product_properties' && $_GET['type']==$k) ? 'active':'' ?>" href="index.html?com=product_properties&act=man&type=<?=$k?>">Danh sách <?=$v['name']?></a></li>
                        <?php }?>
                    </ul>
                </li>
                <?php } ?>
                ...
                <?php foreach ($setting['products'] as $k => $v) { ?>
                    ...
                    <li class="<?=($_GET['com']=='products' || $_GET['table']=='products' || $_GET['com']=='product_posts' || $_GET['table']=='product_posts') ? 'mm-active':''?>">
                        <a class="has-arrow material-ripple" href="#">
                ...
                <?php foreach ($setting['posts'] as $k => $v) { ?>
                    <?php if($v['dropdown']==true){ ?>
                    <li class="<?=($_GET['com']=='posts'|| $_GET['table']=='posts') ? 'mm-active':''?>">
                        <a class="has-arrow material-ripple" href="#">
                ...
                <li class="<?=(!empty($setting['tags'][$_GET['type']]) && $_GET['com']=='tags') ? 'mm-active':''?>">
                    ...
                    <ul class="nav-second-level">
                        ...
                        <?php if($v['dropdown']==false){ ?>
                        <li><a class="<?=($_GET['com']=='tags' && $_GET['type']==$k) ? 'active':''?>" href="index.html?com=tags&act=man&type=<?=$k?>">Danh sách <?=$v['name']?></a></li>
                        <?php } ?>
                        <?php } ?>
                    </ul>
                </li>
