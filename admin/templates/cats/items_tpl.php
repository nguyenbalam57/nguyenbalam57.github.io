                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control basic-single" name="id_list" id="id_list" onchange="window.location.href='index.html?com=cats&act=man&table=<?=$_GET['table']?>&type=<?=$_GET['type']?>&id_list='+this.value">
                        ...
                        <table class="table <?php if($config['paging-table']==true){ ?>v table-borderless no-styling basic<?php }else{ ?>display table-striped table-hover table-border<?php } ?>">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if($csetting['cat-img']==true) { ?>
                                    <td><img src="<?=$path.$v['photo']?>" width="50" onerror="this.src='assets/dist/img/icon-no-image.svg';"></td> <?php }?>
                                    ...
                                    <?php } ?>
                                    <td>
                                        <a href="index.html?com=cats&act=edit<?=$url_type?>&id=<?=$v['id']?>" class="btn btn-success-soft btn-sm mr-1"><i class="far fa-eye"></i></a>
                                        <a href="index.html?com=cats&act=delete<?=$url_type?>&id=<?=$v['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-danger-soft btn-sm"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                <?php } } ?>
                            </tbody>
