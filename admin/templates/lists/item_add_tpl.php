                    ...
                    <div class="card-body">
                        ...
                        <div class="row hinhanh">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="delete-img">
                                        <img src="<?=$path.$item['icon']?>" width="250">
                                        <span class="deleteImg" data-table="<?=$_GET['com']?>" data-path="<?=$path?>" data-id="<?=$item['id']?>"><i class="fa fa-trash"></i></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <p class="text-danger">Width: <?=$setting[$_GET['table']][$_GET['type']]['list-thumbi-w']?>px - Height: <?=$setting[$_GET['table']][$_GET['type']]['list-thumbi-h']?>px</p>
                                </div>
                                <div class="form-group mb-0">
