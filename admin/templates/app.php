...
<head>
        ...
        <link rel="shortcut icon" href="<?=$config_base?>admin/assets/dist/img/logo-ozo.png" type="image/x-icon" />
        <meta name="description" content="JNWEBSITE framework">
        ...
        <link href="assets/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.min.css" rel="stylesheet">
        ...
        <link href="assets/dist/css/style.css?v=<?=time()?>" rel="stylesheet">
        <link href="assets/dist/css/style_themes.css?v=<?=time()?>" rel="stylesheet">
    </head>
    ...
    <body class="theme-<?=$setting_themes['theme_admin']?>">
            ...
            <div class="content-wrapper">
                ...
                <footer class="footer-content">
                    <div class="footer-text d-flex align-items-center justify-content-between">
                        <div class="copy">© 2021 Dashboard <?=$row_setting['name_frame']?> Template</div>
                        <div class="credit">Designed by: <a href="//ahtvietnam.vn" target="_blank"><?=$row_setting['name_frame']?>ahtvietnam co.ltd</a></div>
                    </div>
        ...
        <script src="assets/plugins/ckeditor/ckeditor.js?v=<?=time()?>"></script>
        ...
        <script src="assets/dist/js/custom.js?v=<?=time()?>"></script>
        <?php }else{ ?>
