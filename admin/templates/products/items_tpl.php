                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <?php if($config['im-ex-up-product']==true){ ?>
                        ...
                        <table class="table <?php if($config['paging-table']==true){ ?>v table-borderless no-styling basic<?php }else{ ?>display table-striped table-hover table-border<?php } ?>">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td>
                                         <?php if($csetting['details']){ ?><a href="index.html?com=product_posts&act=man<?=$url_type?>&id_product=<?=$v['id']?>" class="btn btn-primary-soft btn-sm mr-1" data-toggle="tooltip" data-placement="top" title="Thêm thông tin chi tiết"><i class="far fa-clone"></i></a><?php } ?>
                                        <a href="index.html?com=products&act=edit<?=$url_type?>&id=<?=$v['id']?>" class="btn btn-success-soft btn-sm mr-1" data-toggle="tooltip" data-placement="top" title="Sửa sản phẩm"><i class="far fa-eye"></i></a>
                                        <a href="index.html?com=products&act=delete<?=$url_type?>&id=<?=$v['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-danger-soft btn-sm" data-toggle="tooltip" data-placement="top" title="Xóa sản phẩm"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                <?php } } ?>
                            </tbody>
