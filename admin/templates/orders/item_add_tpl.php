                                    ...
                                    <table class="table v table-borderless no-styling basic">
                                        <thead>
                                            <tr>
                                                <th>Hình</th>
                                                <th>Tên</th>
                                                <?php if($config['cart-advanced']==true){ ?>
                                                <th>Color</th>
                                                <th>Size</th>
                                                <?php } ?>
                                                <th>Giá bán</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr >
                                                ...
                                                <td>
                                                    <a class="btn btn-success-soft btn-sm add-click" data-id="<?=$v['id']?>" data-qty="1"><i class="far fa-plus-square"></i></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
