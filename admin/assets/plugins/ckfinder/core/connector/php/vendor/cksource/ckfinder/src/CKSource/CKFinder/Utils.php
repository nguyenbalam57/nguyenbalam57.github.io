...
class Utils
{
    ...
    public static function getRootPath()
    {
         ...
         * For instance, <code>$_SERVER['PHP_SELF']</code> in a script at the address `https://example.com/test.php/foo.bar`
     ...
     * See @link https://php.net/manual/en/function.session-cache-limiter.php
     */
