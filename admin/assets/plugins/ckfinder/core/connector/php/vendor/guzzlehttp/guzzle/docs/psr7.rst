...
.. code-block:: php
    ...
    $request = new \GuzzleHttp\Psr7\Request('MOVE', 'https://httpbin.org/move');
...
.. code-block:: php
    ...
    $response = $client->request('GET', 'https://httpbin.org/get?q=foo');
...
.. code-block:: php
    ...
    echo $request->getUri(); // https://httpbin.org
...
.. code-block:: php
    ...
    $request = new Request('GET', 'https://httpbin.org:8080');
...
.. code-block:: php
    ...
    $request = new Request('GET', 'https://httpbin.org/?foo=bar');
