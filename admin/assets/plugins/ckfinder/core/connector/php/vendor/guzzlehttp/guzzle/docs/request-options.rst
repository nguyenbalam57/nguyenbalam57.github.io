...
.. code-block:: php
    ...
    // https://first-redirect, https://second-redirect, etc...
...
basic
    Use `basic HTTP authentication <https://www.ietf.org/rfc/rfc2069.txt>`_
...
digest
    Use `digest authentication <https://www.ietf.org/rfc/rfc2069.txt>`_
...
.. code-block:: php
    ...
    $request = new Request('GET', 'https://foo.com', ['X-Foo' => 'test']);
    $client->send($request);
...
.. code-block:: php
    ...
    $client->request('GET', 'https://httpbin.org/stream/1024', [
