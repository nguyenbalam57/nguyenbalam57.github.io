...
class Resources
{
    ...
    const DEV_STORE_URI = 'https://127.0.0.1';
    ...
    // Xml Namespaces
    const WA_XML_NAMESPACE   = 'https://schemas.microsoft.com/windowsazure';
    const ATOM_XML_NAMESPACE = 'https://www.w3.org/2005/Atom';
    const DS_XML_NAMESPACE   = 'https://schemas.microsoft.com/ado/2007/08/dataservices';
    const DSM_XML_NAMESPACE  = 'https://schemas.microsoft.com/ado/2007/08/dataservices/metadata';
    const XSI_XML_NAMESPACE  = 'https://www.w3.org/2001/XMLSchema-instance';
