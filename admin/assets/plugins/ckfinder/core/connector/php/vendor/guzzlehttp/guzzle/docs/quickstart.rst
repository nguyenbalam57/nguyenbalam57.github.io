...
``base_uri``
    ...
    `RFC 3986, section 2 <https://tools.ietf.org/html/rfc3986#section-5.2>`_.
...
.. code-block:: php
    ...
    $promise = $client->deleteAsync('https://httpbin.org/delete');
    $promise = $client->headAsync('https://httpbin.org/get');
    $promise = $client->optionsAsync('https://httpbin.org/get');
    $promise = $client->patchAsync('https://httpbin.org/patch');
    $promise = $client->postAsync('https://httpbin.org/post');
    $promise = $client->putAsync('https://httpbin.org/put');
...
.. code-block:: php
    ...
    $headers = ['X-Foo' => 'Bar'];
    $body = 'Hello!';
    $request = new Request('HEAD', 'https://httpbin.org/head', $headers, $body);
...
.. code-block:: php
    ...
    $requests = function ($total) {
        $uri = 'https://127.0.0.1:8126/guzzle-server/perf';
        for ($i = 0; $i < $total; $i++) {
